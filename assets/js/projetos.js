...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function abrirModal(projeto) {
        ...
        projectImage.src = imagens[currentImageIndex];  // Exibe a primeira imagem
        ...
        document.querySelector('[data-carousel-btn="next"]').addEventListener('click', nextImage);
        document.querySelector('[data-carousel-btn="prev"]').addEventListener('click', prevImage);
    
        // Se houver apenas uma imagem, desabilite ambos os botões
        if (imagens.length === 1) {
